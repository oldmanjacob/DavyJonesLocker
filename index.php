    ...
    <section class="main-features-and-benefits-section">
        <div class="features-grid-container">
            ...
            <div class="features-grid-benefits-text-container-right">
                <p class="features-grid-benefits-text">Step into a space that&apos;s equal parts chill and exciting, where every detail is crafted to help you relax, recharge, and enjoy the moment. Whether you&apos;re here to catch up, hang out, or make memories, we&apos;ve got the perfect spot waiting for you.</p>
            </div>
    ...
    <section class="eat-and-drink-section">
        ...
        <div class="eat-and-drink-grid-container">
            ...
            <div class="eat-section-text-container">
                <p class="eat-section-text">Fuel your hangouts with our delicious selection of café bites and snacks, perfect for keeping the good times rolling. Savor freshly made paninis, shareable appetizers, and a variety of light eats designed to satisfy your cravings.</p> 
                <p class="eat-section-text-continued"> Whether you're grabbing a quick snack or settling in for a full meal, our menu has something to keep you energized and coming back for more.</p>
                <a href="#" class="dead-link">Our Food Menu ></a>
            </div>
            <div class="drink-section-content-container">
                <h2 class="drink-section-headline auto-animate">( . . . or a drink)</h2>
                <p>Quench your thirst with a curated selection of craft beers, fine wines, and indulgent coffee creations. From bold mochas to refreshing brews, our drink menu is crafted to complement any mood.</p>
                <p>Whether you're unwinding with a glass of wine, sipping on a rich latte, or exploring local craft beers, there's a drink for every occasion at Davy Jones' Locker.</p>
                <a href="#" class="dead-link">Our Drink Menu ></a>
            </div>
    ...
    <section class="entertainment-section-bottom">
        <div class="comedy-section width-limiter">
            ...
            <div class="comedy-section-content">
                ...
                <p class="comedy-section-text">Get ready for nights filled with laughter as Davy Jones' Locker hosts talented comedians who know how to keep the good times rolling. From sharp wit to side-splitting stories, our comedy shows are the perfect way to unwind and share a laugh with friends.
                    <br><br>Don't miss the fun—come for the jokes, stay for the memories.</p>
                <a href="#" class="dead-link">More ></a>
        ...
        <div class="music-section width-limiter">
            <div class="music-section-content">
                ...
                <p class="music-section-text">Feel the rhythm at Davy Jones' Locker, where weekends come alive with beats from talented DJs. Whether you're into high-energy dance tracks, chill lo-fi vibes, or electrifying EDM, our music lineup has something for everyone.
                    <br><br>Bring your moves, grab your crew, and let the music set the tone for an unforgettable night.</p>
                <a href="#" class="dead-link">More ></a>
                    ...
                    <div class="events-one-event-card">
                        <div class="events-one-event-card-image">
                            ...
                            <div class="events-one-event-card-date-box">
                                ...
                                <span class="events-one-event-card-date">TBD</span>
...
<?php include 'footer.php'; ?>
    <div class="popup-overlay" id="deadLinkPopup">
        <div class="popup">
            <button class="close-popup" id="closePopup">&times;</button>
            <h2>Oops!</h2>
            <p>We are still working on that! Check back soon or join our mailing list to be notified when the website is complete.</p>
        </div>
    </div>
</body>
</html>